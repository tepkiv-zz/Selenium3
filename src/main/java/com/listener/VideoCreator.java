...
public class VideoCreator {
    ...
    private static final Dimension SCREEEN_BOUNDS = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public void createVideoFromScreen() {
        ...
        try {
            ...
            writer.addVideoStream(0, 0, SCREEEN_BOUNDS.width, SCREEEN_BOUNDS.height);
